...
namespace PackageManagement.AppSyndication.Navigation {
    ...
    internal class Package : Swid {
        ...
        internal Package(Request request, Swidtag swidtag)
            : base(request, swidtag) {
        }

        internal Package(Request request, IEnumerable<Link> mirrors)
            : base(request, mirrors) {
        }

        internal Package(Request request, IEnumerable<Uri> mirrors)
            : base(request, mirrors) {
        }
